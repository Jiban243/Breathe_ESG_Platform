...
class Command(BaseCommand):
    help = 'Seeds core emission factors cleanly into the active database instance'
    ...
    def handle(self, *args, **options):
        ...
        self.stdout.write(self.style.SUCCESS(f'>>> Automated Ingestion Pipe Complete: {EmissionFactor.objects.count()} factors verified.'))